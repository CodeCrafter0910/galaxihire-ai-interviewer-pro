  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .auth-stagger-7 { animation: auth-fade-up 0.7s ease-out 0.7s both; }
      `}</style>
          ...
          <div className="relative z-10 px-12 xl:px-16 w-full max-w-xl">
            ...
            <div style={{ animation: "auth-slide-right 0.8s ease-out both" }}>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-sm">
                Prepare smarter. Interview better. Land your dream role with AI-powered practice sessions.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-white font-semibold text-sm">AI Scoring & Feedback</p>
                  <p className="text-gray-400 text-xs mt-0.5">Real-time evaluation of your answers</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p className="text-white font-semibold text-sm">PDF Reports</p>
                  <p className="text-gray-400 text-xs mt-0.5">Detailed performance analysis reports</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-0.5">Practice with domain-specific questions</p>
                </div>
              </div>
            </div>
          </div>
