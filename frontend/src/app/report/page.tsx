        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-6 flex items-center justify-between animate-fade-in">
            ...
            <button
              ...
              className="group px-8 py-3.5 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-xl font-bold transition-all duration-200 shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-105 flex items-center gap-2"
            >
              Start New Interview
          ...
          {view === "list" && (
            <div className="mt-6">
              {reports.length === 0 ? (
                <div className="glass p-16 rounded-2xl text-center border border-white/10 relative overflow-hidden group">
                  {/* Glow effect */}
                  ...
                  <div className="relative z-10">
                    ...
                    <button
                      onClick={() => router.push("/interview")}
                      className="group/btn px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white rounded-xl font-bold text-lg transition-all duration-200 shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-105 inline-flex items-center gap-2"
                    >
                ...
                <div className="grid grid-cols-1 gap-5">
                  {reports.map((r, idx) => (
                    <div
                      key={r._id}
                      className="glass p-8 rounded-2xl cursor-pointer hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-indigo-500/30 hover:scale-[1.02] group relative overflow-hidden"
                      onClick={() => {
                        setReport(r);
                        setView("detail");
                      }}
                      ...
                      <div className="flex items-start justify-between relative z-10">
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-5 gap-4 mt-5">
                            <div className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 p-4 rounded-xl border border-indigo-500/30 hover:scale-105 transition-transform">
                            ...
                            <div className="bg-black/30 p-4 rounded-xl border border-white/10 hover:scale-105 transition-transform">
                        ...
                        <button
                          ...
                          className="ml-6 group/btn px-6 py-3 bg-gradient-to-r from-green-500/20 to-emerald-500/20 hover:from-green-500/30 hover:to-emerald-500/30 text-green-300 rounded-xl font-semibold transition-all duration-200 border border-green-500/30 hover:border-green-500/50 hover:scale-105 flex items-center gap-2"
                        >
          ...
          {view === "detail" && report && (
            <div className="mt-6 animate-fade-in">
              ...
              <div className="glass p-10 rounded-2xl border border-white/10 hover:border-indigo-500/20 transition-all duration-300 relative overflow-hidden group">
                {/* Glow effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-8">
                    ...
                    <div className="flex-1">
                      <h2 className="text-3xl font-black text-white mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white via-indigo-200 to-purple-200">
                        {report.summary}
                      </h2>
                      {report.interviewId && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 mb-10">
                    {([
                      ...
                      return (
                        <div key={key} className={`p-6 rounded-2xl border transition-all duration-300 hover:scale-105 relative overflow-hidden group/card ${
                          accent
                          ...
                          {/* Corner decoration for accent card */}
                          {accent && (
